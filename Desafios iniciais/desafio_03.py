...
Assim, você conseguirá passar para Rubens qual a distância percorrida e em seguida ...
Calcular quantos litros serão necessários para a viagem que ele quer fazer. Mostre o valor com 3 casas decimais após o ponto.
...
quantidade_litros_combustivel = f'{combustivel}'

print(quantidade_litros_combustivel)
