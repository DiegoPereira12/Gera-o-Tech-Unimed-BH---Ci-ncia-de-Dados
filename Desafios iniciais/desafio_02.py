...
Em 2012 foi alcançado um novo recorde mundial na famosa Competição de Cachorros-Quentes do Nathan: o campeão, Joey Chestnut, devorou 68 cachorros-quentes em dez minutos,
...
calculo = cachorros_quentes / pessoas

media_cachorros_quentes = f"{calculo:.2f}"

print(media_cachorros_quentes)